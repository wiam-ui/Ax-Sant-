  ...
  counters.forEach(counter => {
    const updateCount = () => {
      ...
      if (count < target) {
        ...
        setTimeout(updateCount, 20); // controls speed
      } else {
...
const imageContainer = document.getElementById('switchable-image');
...
buttons.forEach(button => {
  button.addEventListener('click', () => {
    ...
    setTimeout(() => {
      // Change images
      mainImage.src = button.getAttribute('data-main');
      hoverImage.src = button.getAttribute('data-hover');
...
// Optional: Trigger initial animation
